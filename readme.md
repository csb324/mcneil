...
3. Check out the options
    ...
    For example, suppose I had a friend named Cynthia, and I'm making her a website. She really wants the "i" in her name to be lowercase no matter what, for some reason, but I'm using "text-transform: uppercase" on some header elements.
